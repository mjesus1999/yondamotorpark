      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="d-block d-md-none">
            ...
            <?php else: ?>
              <div class="accordion" id="acordeonConcesionarios">
                <?php $numeroFila = 1; ?>
                <?php foreach ($concesionarios as $concesionario): ?>
                  <div class="accordion-item mb-2 shadow-sm">
                    <h2 class="accordion-header" id="heading-<?= $concesionario['idconcesionario'] ?>">
                      <button class="accordion-button collapsed" type="button"
                        ...
                        <span class="fw-bold"><i class="bi bi-truck me-2"></i><?= htmlspecialchars($concesionario['nombrecomercial']) ?></span>
                      </button>
                    </h2>
                    <div id="collapseConcesionario<?= $concesionario['idconcesionario'] ?>"
                      class="accordion-collapse collapse"
                      aria-labelledby="heading-<?= $concesionario['idconcesionario'] ?>"
                      data-bs-parent="#acordeonConcesionarios">
