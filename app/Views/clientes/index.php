    ...
    <div class="alert alert-info mt-2" role="alert">
        <div class="row">
            ...
            <div class="col-md-6 d-flex align-items-center justify-content-end gap-2">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item"><a href="/empresas/">Jurídicas (Empresas)</a></li>
                    </ol>
                </nav>
                        ...
                        <table class="table table-sm table-hover table-hover-yonda" id="tabla-clientes-personas">
                            ...
                            <<tbody>
                                ...
                                <?php if (empty($personClientes)): ?>
                                    <tr>
                                        <td colspan="8" class="text-center">No hay clietes personas registradas.</td>
                                    </tr>
                                <?php else: ?>
                                    <?php $numeroFila = 1 ?>
                                    <?php foreach ($personClientes as $personCliente): ?>
                                        <tr>
                                            ...
                                            <td><?= htmlspecialchars($personCliente['email']) ?></td>
                                            <td><?= htmlspecialchars($personCliente['telprimario']) ?></td>
                                            <td>
                                                  <a href="/personas/edit/<?= htmlspecialchars($personCliente['idpersona']) ?>"
                                                    class="btn btn-sm btn-outline-primary"> <i class="fa-solid fa-pen"></i></a>
                                                
                                                <form action="/clientes/delete/<?= htmlspecialchars($personCliente['idcliente']) ?>" method="POST" class="d-inline"
