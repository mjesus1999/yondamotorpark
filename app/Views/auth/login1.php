        ...
        <div class="col-md-12 col-lg-10">
          <div class="wrap d-md-flex">
            ...
            <div class="login-wrap p-4 p-md-5">
              ...
              <form action="/login" method="POST" class="signin-form" id="formulario-login" autocomplete="ON">
                <div class="form-group mb-3">
                  <label class="label" for="usernick">Nombre de usuario</label>
                  <input type="text" id="usernick" name="usernick" class="form-control" placeholder="Nombre de usuario"
                    required value="<?= isset($old['usernick']) ? htmlspecialchars($old['usernick']) : '' ?>">
                </div>
                <div class="form-group mb-3">
