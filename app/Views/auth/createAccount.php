...
<body>
  <style>.yonda { background-color: #FF5F00; }</style>
  ...
  <section class="ftco-section pt-5">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="card">
            <div class="card-header"><div class="row"><div class="col">Contratos</div></div></div>
            <div class="card-body">
              <table class="table table-sm table-hover contracts-table" id="tabla-contratos">
                ...
                <thead>
                  <tr><th>#</th><th>Nombre</th><th>Área</th><th>Cargo</th></tr>
                </thead>
                <tbody>
                  <?php if (!empty($contracts)): ?>
                    <?php foreach ($contracts as $c): ?>
                      <!-- añadimos data-nombres y data-apellidos -->
                    ...
                    <?php endforeach; ?>
                  <?php else: ?>
                    <tr><td colspan="4" class="text-center small text-muted py-3">No hay contratos sin cuenta.</td></tr>
                  <?php endif; ?>
                </tbody>
              </table>
            </div>
        ...
        <div class="col-md-6">
          ...
          <form method="POST" action="/createFromContract" id="form-create" autocomplete="off">
            ...
            <div class="mb-2">
              ...
              <input name="usernick" id="usernick" class="form-control" value="<?= $old['usernick'] ?? '' ?>" required>
              <div class="form-text small text-muted">Sugerencia: pulsa el nombre en la lista para autocompletar.</div>
            </div>
  ...
  <script>
    // al hacer click en una fila rellenamos form y sugerimos usernick
    document.querySelectorAll('.contracts-table tbody tr[data-id]').forEach(function (row) {
      row.addEventListener('click', function () {
        ...
        // sugerir usernick: nombre.apellido (simple)
