...
<body>
    ...
    <script>
        ...
        function showPDFPreview(filename) {
            ...
            // El botón de descarga usa el mismo blob global
            btnDownload.addEventListener('click', () => {
                try {
                    if (globalPdfBlob) {
                        downloadPdfFromBlob(globalPdfBlob, filename);
                        ...
                        table: {
                            ...
                            body: [
                                ...
                                [
                                    ...
                                    { text: ':', style: 'detalleSeparador' },
                                    { text: 'L3HMCKBE3PA000222', style: 'detalleValue' }
                                ],
                                [
                                    { text: 'Motor', style: 'detalleLabel' },
                                    { text: ':', style: 'detalleSeparador' },
                                    { text: '209000222', style: 'detalleValue' }
                                ],
                                [
                                    { text: 'Color', style: 'detalleLabel' },
                                    { text: ':', style: 'detalleSeparador' },
                                    { text: 'Negro', style: 'detalleValue' }
                                ],
                                [
                                    { text: 'Placa', style: 'detalleLabel' },
                                    { text: ':', style: 'detalleSeparador' },
                                    { text: 'Z7L-222', style: 'detalleValue' }
                                ]
                            ]
                        },
                        layout: {
        ...
        async function generatePDFNotificacion() {
            ...
            try {
                ...
                globalFilename = 'notificacion-cobranza-juan-perez.pdf';
