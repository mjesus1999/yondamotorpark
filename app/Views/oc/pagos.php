                ...
                <div class="card-header card-header-pagos d-flex justify-content-between align-items-center">
                    <h6 class="mb-0 fw-semibold">
                        ...
                        <?php if (isset($concesionario['concesionario'])): ?>
                            Concesionario: <span class="badge bg-white text-primary" id="concesionario"><?= htmlspecialchars($concesionario['concesionario']) ?> - <?= $concesionario['ubicacion'] ?></span> -
                        <?php endif; ?>
                        <?php if (isset($concesionario['idordencompra'])): ?>
                            ...
                            <span class="badge bg-white text-primary ms-2" id="numeroIdentificadorOC"><?= htmlspecialchars($concesionario['numeroOCIdentificador']) ?></span>
                        <?php endif; ?>
                    </h6>
                    <div>
                        <span class="badge bg-white text-primary badge-pill m-2" id="total-pagado">
                                ...
                                <?php if (!empty($pagos)): ?>
                                    ...
                                    <?php foreach ($pagos as $pago): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?= htmlspecialchars($pago['entidad'] ?? 'N/A') ?>
                                            </td>
                                            ...
                                            <td class="celda-observaciones" data-bs-toggle="tooltip" title="<?= htmlspecialchars($pago['observaciones'] ?? '') ?>">
                                                <?php if (!empty($pago['observaciones'])): ?>
                                                    <button type="button" class="btn btn-link p-0 ver-detalle-observacion"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#modalDetalleObservacion"
                                                        data-observacion="<?= htmlspecialchars($pago['observaciones']) ?>">
            ...
            <div class="modal-content modal-pago">
                ...
                <div class="modal-body">
                    <form id="formPago" enctype="multipart/form-data" autocomplete="off">
                        ...
                        <!-- Sección 1: Información de Montos -->
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="d-flex justify-content-between border rounded p-2 bg-body">
                                            ...
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label fw-semibold text-body" for="usd">
                                                    USD
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input border-primary" type="radio" name="moneda" id="pen" value="PEN">
                                                <label class="form-check-label fw-semibold text-body" for="pen">
                                                    SOLES
                                                </label>
                                            </div>
                                        </div>
                        ...
                        <!-- Sección 2: Detalles de Transacción -->
                        <div class="card mb-4 border-0 shadow-sm">
                            <div class="card-header bg-info text-white py-2">
                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                    ...
                                    <!-- Entidad y N° Transacción -->
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <select class="form-select" id="identidadpago" name="identidadpago" required>
                                                <?php foreach ($entidadesPago as $entidad): ?>
                                                    <option value="<?= htmlspecialchars($entidad['identidadpago']) ?>">
                                                        <?= htmlspecialchars($entidad['entidad']) ?>
                                                    </option>
                                                <?php endforeach; ?>
                                            </select>
